...
export const NAG_PATHWAYS: NagPathway[] = [
  {
    ...
    patientGroup: "Any",
    firstLine: "Penicillin V 500mg PO QID (or 1g PO BD) x 5-10 days",
    alternatives: [
      { when: "Alternative / penicillin allergy", regimen: "Erythromycin Ethylsuccinate 800mg PO BD x 5-10 days" },
    ],
    ...
    cautions: [
      ...
      "Amoxicillin 500mg PO TDS x 5-10 days is an equally preferred adult alternative to Penicillin V.",
    ...
    allergyWeightBased: { kind: "mgPerKgPerDay", drug: "Erythromycin Ethylsuccinate", mgPerKgPerDayRange: [40, 50], frequency: "BD", durationDaysRange: [10, 10], maxMgPerDay: 1600 },
  },
  {
    id: "cap",
    ...
    patientGroup: "Any",
    firstLine: "Amoxicillin 500-1000mg PO TDS x 5-7 days (mild, outpatient, no comorbidities)",
    alternatives: [
      { when: "Penicillin allergy", regimen: "Doxycycline 100mg PO BD x 5-7 days" },
    ],
    ...
    cautions: [
      ...
      "With comorbidities (chronic heart/lung/liver/kidney disease, diabetes, alcoholism, malignancy, asplenia): use Amoxicillin/Clavulanate 625mg TDS, adding Azithromycin 500mg OD x3 days or Doxycycline if an atypical pathogen is suspected — not modelled here, use AI Suggest or the full guideline.",
    ],
    source: "NAG 2024 — Acute Bronchitis and Pneumonia, adult table (v30 Jan 2026)",
    // Source gives "q8-12h" (2-3 doses/day) — BD matches the original data's
    // convention for this drug and is the more common administration for
    // high-dose amoxicillin in practice.
    ...
    allergyWeightBased: { kind: "mgPerKgPerDay", drug: "Erythromycin Ethylsuccinate", mgPerKgPerDayRange: [40, 50], frequency: "BD", durationDaysRange: [5, 5], maxMgPerDay: 1600 },
  },
  {
    id: "aom",
    ...
    patientGroup: "Any",
    firstLine: "Amoxicillin 500mg PO TDS x 5-7 days",
    alternatives: [
      { when: "Penicillin allergy", regimen: "Erythromycin Ethylsuccinate 400mg PO QID OR 800mg PO BD x 5-7 days" },
    ],
    durationDaysRange: [5, 10],
    ...
    allergyWeightBased: { kind: "mgPerKgPerDay", drug: "Erythromycin Ethylsuccinate", mgPerKgPerDayRange: [40, 50], frequency: "BD", durationDaysRange: [5, 10], maxMgPerDay: 1600 },
  },
  {
    id: "abrs",
    ...
    patientGroup: "Any",
    firstLine: "Amoxicillin 500-1000mg PO TDS x 5 days",
    alternatives: [
      { when: "Penicillin allergy", regimen: "Doxycycline 100mg PO BD x 5-7 days" },
    ],
    ...
    cautions: [
      ...
      "Amoxicillin/Clavulanate 625mg PO TDS x 5 days is an equally preferred adult alternative to Amoxicillin.",
      "In pregnant patients with penicillin allergy, use Azithromycin 500mg PO OD x 3 days instead of Doxycycline.",
    ...
    allergyWeightBased: { kind: "mgPerKgPerDay", drug: "Cefuroxime", mgPerKgPerDayRange: [30, 30], frequency: "BD", durationDaysRange: [5, 5], maxMgPerDay: 1000 },
  },
  {
    id: "ssti",
    ...
    patientGroup: "Any",
    firstLine: "Cephalexin 1000mg PO BD x 5-10 days (cellulitis)",
    alternatives: [
      { when: "Antibiotic allergy", regimen: "Erythromycin Ethylsuccinate 800mg PO BD x 5-7 days" },
    ],
    durationDaysRange: [5, 10],
    allowedDrugs: ["Cephalexin", "Erythromycin Ethylsuccinate"],
    cautions: [
      "Cloxacillin 500mg PO QID x 5-10 days is an equally preferred alternative; Amoxicillin 500mg PO TDS x 5-10 days may also be used for cellulitis.",
  ...
  },
  {
    ...
    patientGroup: "Adult",
    firstLine: "Nitrofurantoin 50-100mg PO QID (immediate release) OR 100mg PO BD (modified release) x 5 days",
    alternatives: [
      { when: "eGFR < 30 mL/min, or alternative preferred", regimen: "Cephalexin 500mg PO BD-QID x 5 days" },
    ],
