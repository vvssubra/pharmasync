...
const items: NavItem[] = [
  ...
  { title: "Drug Request",    url: "/request/ubat",       icon: ClipboardList, roles: ["admin", "fms", "mo", "pharmacist"] },
  { title: "Antibiotic Form", url: "/request/antibiotik", icon: Pill,          roles: ["admin", "fms", "mo", "pharmacist"] },
